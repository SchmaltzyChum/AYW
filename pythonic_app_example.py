...
class WelcomePage(Screen):
    def __init__(self, **kwargs):
        ...
        self.welcome_label = Label(text='Welcome to Radial!', color=(0, 0, 0, 1))
        layout.add_widget(self.welcome_label)

        self.get_started_button = Button(text='Get Started', size_hint_y=None, height=50)
...
class MenuPage(Screen):
    def __init__(self, **kwargs):
        ...
        self.menu_label = Label(text='Menu Page', font_size='30sp', size_hint_y=None, height='40sp', halign='center', valign='middle', color=(0, 0, 0, 1))
